    ...
    public static class BuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Genre>().HasData(
              new Genre { Id = 1, Name = "Video Games", Picture = "https://images.unsplash.com/photo-1606160429008-751d8408a874?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1562&q=80" },
              new Genre { Id = 2, Name = "Tv Show/Movies", Picture = "https://images.unsplash.com/photo-1485846234645-a62644f84728?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1340&q=80" },
              new Genre { Id = 3, Name = "Comics", Picture = "https://images.unsplash.com/photo-1588497859490-85d1c17db96d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80" },
              new Genre { Id = 4, Name = "Electronics", Picture = "https://images.unsplash.com/photo-1519389950473-47ba0277781c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80" }
            );
            ...
            new Item
            {
                ...
                OpeningDate = new DateTime(2018, 10, 26)
            },
            new Item
            {
                Id = 2,
                ...
                OpeningDate = new DateTime(2018, 04, 20)
            },
            new Item
            {
                Id = 3,
                ...
                OpeningDate = new DateTime(2018, 09, 14)
            }
            ); 
